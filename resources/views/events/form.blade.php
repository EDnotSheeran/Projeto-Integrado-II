                            ...
                            <div class="p-5">
                                ...
                                @if (Request::is('*/editar'))
                                    <form id="form-update" class="user" method="POST"
                                        action="{{ route('eventos.editar', $evento->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                                ...
                                                <div class="file-field">
                                                    <div class="mb-4">
                                                        <label for="imagemEvento" image-preview="Fazer Upload">
                                                            <img src="{{ asset($evento->imagem) }}" class="placeholder"
                                                                alt="placeholder">
                                                    </div>
                                                    </label>
                                            ...
                                            <div class="col-sm-12 mb-3 mb-sm-0 col-lg-7 col-xl-8">
                                                <div class="col-sm-12 mb-3" tooltip="{{ __('Name') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.nome') is-invalid @enderror"
                                                        id="nomeEvento" name="evento[nome]" required
                                                        value="{{ $evento->nome }}" placeholder="{{ __('Name') }}">
                                                    @error('evento.nome')
                                                ...
                                                <div class="row mx-1">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="date"
                                                            class="form-control form-control-user @error('evento.data') is-invalid @enderror"
                                                            id="eventoData" name="evento[data]" required
                                                            value="{{ $evento->data }}" tooltip="{{ __('Date') }}">
                                                        @error('evento.data')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="col-sm-6 mb-3">
                                                        <input type="time"
                                                            class="form-control form-control-user @error('evento.hora') is-invalid @enderror"
                                                            id="hora" name="evento[hora]" required
                                                            value="{{ $evento->hora }}" tooltip="{{ __('Hour') }}">
                                                        @error('evento.hora')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="col-sm-12 mb-3" tooltip="{{ __('Speaker Name') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.nome_palestrante') is-invalid @enderror"
                                                ...
                                                <div class="row mx-1">
                                                    <div class="col-sm-6 mb-3 mb-sm-0"
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-user @error('evento.vagas_disponiveis') is-invalid @enderror"
                                                    ...
                                                    <div class="col-sm-6 mb-3">
                                                        <input type="time"
                                                            class="form-control form-control-user @error('evento.duracao') is-invalid @enderror"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12 mb-3 mb-sm-0 col-lg-7 col-xl-8">
                                                            <div class="col-sm-12 mb-3"
                                                                ...
                                                                <input type="text"
                                                                    class="form-control form-control-user @error('certificado.nome') is-invalid @enderror"
                                                            ...
                                                            <div class="col-sm-12 mb-3"
                                                                ...
                                                                <textarea
                                                                    class="form-control form-control-user @error('certificado.texto') is-invalid @enderror"
                                            ...
                                            <div class="form-group row col-12 mx-auto">
                                                <div class="col-sm-12 mb-3" tooltip="{{ __('Event Description') }}">
                                                    <textarea
                                                        class="form-control form-control-user @error('evento.descricao') is-invalid @enderror"
                                            ...
                                            <div class="form-group row col-12 mx-auto">
                                                <div class="col-sm-12 mb-3 col-md-4" tooltip="{{ __('cep') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.cep') is-invalid @enderror"
                                                        id="cepEvento" name="evento[cep]" required
                                                        value="{{ $evento->cep }}" placeholder="{{ __('cep') }}">
                                                    @error('evento.cep')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-sm-12 mb-3 col-md-2" tooltip="{{ __('uf') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.uf') is-invalid @enderror"
                                                        id="ufEvento" name="evento[uf]" required
                                                        value="{{ $evento->uf }}" placeholder="{{ __('uf') }}"
                                                        readonly>
                                                    @error('evento.uf')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-sm-12 mb-3 col-md-6" tooltip="{{ __('cidade') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.cidade') is-invalid @enderror"
                                                        id="cidadeEvento" name="evento[cidade]" required
                                                        value="{{ $evento->cidade }}" placeholder="{{ __('cidade') }}"
                                                        readonly>
                                                    @error('evento.cidade')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group row col-12 mx-auto">
                                                <div class="col-sm-12 mb-3 col-md-10" tooltip="{{ __('Address') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.endereco') is-invalid @enderror"
                                                ...
                                                <div class="col-sm-12 mb-3 col-md-2" tooltip="{{ __('numero') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.numero') is-invalid @enderror"
                                            ...
                                            <div class="form-group row col-12 mx-auto">
                                                <div class="col-sm-12 mb-3 col-md-6" tooltip="{{ __('District') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.bairro') is-invalid @enderror"
                                                ...
                                                <div class="col-sm-12 mb-3 col-md-6" tooltip="{{ __('Local') }}">
                                                    <input type="text"
                                                        class="form-control form-control-user @error('evento.local') is-invalid @enderror"
                                                        id="localEvento" name="evento[local]" required
                                                        value="{{ $evento->local }}" placeholder="{{ __('Local') }}">
                                                    @error('evento.local')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row col-12 mx-auto">
                                                <div class="col-sm-12 mb-3 col-md-6" tooltip="{{ __('Event Status') }}">
                                                    <select
                                                        class="form-control form-control-user @error('evento.status') is-invalid @enderror"
                                                        id="statusEvento" name="evento[status]" required>
                                                        <option value="" disabled selected>{{ __('Event Status') }}
                                                        </option>
                                                        <option value="1" {{ $evento->status == '1' ? 'selected' : '' }}>
                                                            Ativo</option>
                                                        <option value="0" {{ $evento->status == '' ? 'selected' : '' }}>
                                                            Desativado</option>
                                                    </select>
                                                    @error('evento.status')
                                                        <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="col-sm-12 mb-3 col-md-6" tooltip="{{ __('Method') }}">
                                                    <select
                                                        class="form-control form-control-user @error('evento.metodo') is-invalid @enderror"
                                                        id="metodoEvento" name="evento[metodo]" required>
                                                        <option value="" disabled selected>{{ __('Method') }}</option>
                                                        <option value="1" {{ $evento->metodo == '1' ? 'selected' : '' }}>
                                                            Ativo</option>
                                                        <option value="0" {{ $evento->metodo == '' ? 'selected' : '' }}>
                                                            Desativado</option>
                                                    </select>
                                                    @error('evento.metodo')
                                                        <span class="invalid-feedback" role="alert">
                                ...
                                @else
                                    {{-- Create --}}
                                    <form class="user" method="POST" action="{{ route('eventos.novo') }}"
                                                ...
                                                <div class="form-group row col-12 mx-auto">
                                                    ...
                                                    <div class="col-sm-12 mb-3 col-md-6" tooltip="{{ __('Cidade') }}">
                                                        <input type="text"
                                                            ...
                                                            placeholder="{{ __('Cidade') }}" readonly>
                                                        @error('evento.cidade')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="form-group row col-12 mx-auto">
                                                    <div class="col-sm-12 mb-3 col-md-6"
                                                        ...
                                                        <select
                                                            ...
                                                            <option value="1"
                                                                {{ old('evento.status') == 'true' ? 'selected' : '' }}>
                                                                Ativo</option>
                                                            <option value="0"
                                                                {{ old('evento.status') == 'false' ? 'selected' : '' }}>
                                                                Desativado</option>
                                                        </select>
                                                        @error('evento.status')
                                                            <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="col-sm-12 mb-3 col-md-6" tooltip="{{ __('Method') }}">
                                                        <select
                                                            class="form-control form-control-user @error('evento.metodo') is-invalid @enderror"
                                                            id="metodoEvento" name="evento[metodo]" required>
                                                            <option value="" disabled selected>{{ __('Method') }}
                                                            </option>
                                                            <option value="1"
                                                                {{ old('evento.metodo') == 'true' ? 'selected' : '' }}>
                                                                Ativo</option>
                                                            <option value="0"
                                                                {{ old('evento.metodo') == 'false' ? 'selected' : '' }}>
                                                                Desativado</option>
                                                        </select>
                                                        @error('evento.metodo')
                                                            <span class="invalid-feedback" role="alert">
