...
window.utils = __webpack_require__(/*! ./utils */ "./resources/js/utils.js");
...
var toggleActive = function toggleActive(id) {
  ...
  return (_document$getElementB = document.getElementById(id)) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.classList.toggle("active");
};
