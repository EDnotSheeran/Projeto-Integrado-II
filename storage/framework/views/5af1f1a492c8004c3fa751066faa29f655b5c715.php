        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('home')); ?>">
                    ...
                    <div class="sidebar-brand-text mx-3">Laravel <sup><?php echo e(__('events')); ?></sup></div>
                </a>
                ...
                <?php if(Auth::user()->isAdmin): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('jobs')); ?>">
                            <i class="fas fa-briefcase"></i>
                            <span><?php echo e(__('Jobs')); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('headOffices')); ?>">
                            <i class="fas fa-building"></i>
                            <span><?php echo e(__('HeadOffices')); ?></span>
                        </a>
                    </li>
                    <!-- Divider -->
                    <hr class="sidebar-divider">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('user.agenda')); ?>">
                        <i class="fas fa-calendar"></i>
                        <span><?php echo e(__('My Agenda')); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('certificate')); ?>">
                        <i class="fas fa-scroll"></i>
                        <span><?php echo e(__('My Certificates')); ?></span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <form
                            onsubmit="event.preventDefault();location.href = '<?php echo e(route('home')); ?>?search=' + document.getElementById('search').value;"
                            class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" id="search" class="form-control bg-light border-0 small"
                                    placeholder="<?php echo e(__('Search for events...')); ?>" aria-label="Search"
...
<?php /**PATH /Users/ednotsheeran/Documents/Github/Projeto-Integrado-II/resources/views/layouts/admin.blade.php ENDPATH**/ ?>